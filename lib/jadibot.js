...
const jadibot = async(reply,client,id,m) => {
    ...
    conn.on('qr', async qr => {
    	...
    	let buffer = new Buffer.from(bot.replace('data:image/png;base64,', ''), 'base64')
           bot = await client.sendMessage(id, { image: buffer,  caption: 'Scan QR Untuk menjadi bot\n*Rules:*\nQR akan diganti setiap 30 detik' }, { quoted: m })
    	setTimeout(() => {
